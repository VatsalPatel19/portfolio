      ...
      <div className='row projectrow'>
        ...
        <div className="card">
          ...
          <div className="container">
            <p className='text-center'>Personal Portfolio</p><p>This website is developed using ReactJs.</p>
        ...
        <div className="card">
          ...
          <div className="container">
            ...
            <p>Secure Image Steganographic software in which encryption is done
              using Blowfish Algorithm and Transmission of Image is done using Apache Kafka.</p>
            <p className='text-center'><a href='https://ieeexplore.ieee.org/document/9716292' target="blank"><button type="button">View Project</button></a></p>
          </div>
        </div>
